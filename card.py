'''
Card class represents the entire card object
Each card has a name and power
Each card has some kind of additional feature that is
typically a special action invoked when the card is played
'''
